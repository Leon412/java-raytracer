...
import com.safjnest.image.Image;
import com.safjnest.image.ImageColor;
...
public class RayTracer {
    ...
    private static final Scene SCENE2 = new Scene(
            new Vector3(0, 0, 2),
            new ImagePlane(
    ...
    public static void main(String [] args) throws IOException {
        ...
        com.safjnest.tracer.RayTracer tracer = new com.safjnest.tracer.RayTracer(SCENE, W, H);
        ...
        try (Image image = new Image(W, H)) {
            ...
            image.save(Paths.get("image.png"));
        }
        w.stop();
        System.out.println("finished in " + w.getElapsedTimeMillis() + " ms");
    }
